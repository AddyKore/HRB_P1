...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  2 22:24:36 2023
...
class RobotSimInterface( object ):
  ...
  def refreshState( self ):
    ...
    '''is this where I shall implement the particle filter'''
  ...
  def getTagList( self ):
    ...
    return tags2list(state) + self._msg
...
class SimpleRobotSim( RobotSimInterface ):
    def __init__(self, *args, **kw):
        ...
        self.app = app
        self.motors = [app.robot.at.m1, app.robot.at.m2,
                app.robot.at.m3, app.robot.at.m4]
        #motor 1 and 4 control front and back, motor 2 and 3 control left and right
        #self.motorP = TurnMotors(app, self.motors[0:-1])
        #self.motorP.start()
    ...
    def moveb(self,dist):
        ...
        self.position[0]= self.position[0] +dist*100
        self.position[3]= self.position[3] +dist*100
    ...
    def movel(self,dist):
        ...
        self.position[1]= self.position[1] +dist*100
        self.position[2]= self.position[2] +dist*100
        self.motors[1].set_pos(self.position[1])
        self.motors[2].set_pos(-self.position[2])
